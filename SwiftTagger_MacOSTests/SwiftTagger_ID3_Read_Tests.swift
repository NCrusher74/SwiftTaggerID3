...
class SwiftTagger_ID3_Read_Tests: XCTestCase {
    ...
    func testReadV22() throws {
        ...
        #warning("figure out why the last charcter is being dropped")
        ...
        XCTAssertTrue(tag.involvedPeopleList[0] == (role: "Director", person: "Director Name"))
        XCTAssertTrue(tag.involvedPeopleList[1] == (role: "Producer", person: "Producer Name"))
